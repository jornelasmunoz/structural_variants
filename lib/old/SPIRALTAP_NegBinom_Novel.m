...
%Comments which begin with APL were written by Andrew Peter Lazar
%APL: This code will function as SPIRALTAP but will call the Negative
%Binomial Random Variable and will show Negative Binomial Noise. 

function [x, varargout] = SPIRALTAP_NegBinom_Novel(y, A, tau, varargin)
...
% ---- For Poisson Noise and Negative Binomial Noise (APL)  ----
logepsilon = 1e-10;
sqrty = [];
