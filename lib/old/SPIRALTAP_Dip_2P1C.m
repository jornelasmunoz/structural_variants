...
function [x, varargout] = SPIRALTAP_Dip_2P1C(y, A, tau, varargin)
...
spiraltapdir = which('SPIRALTAP_Dip_2P1C');
...
if (verbose > 0)
    thetime = fix(clock);
    fprintf(['=========================================================\n',...
        '= Beginning SPIRAL_Dip_2p1c Reconstruction  @ %2d:%2d %02d/%02d/%4d =\n',...
        '=   Noisetype: %-8s         Penalty: %-9s      =\n',...
        '=   Tau Val:       %-10.5e      Maxiter: %-5d          =\n',...
        '=========================================================\n'],...
...
function subsolution = computesubsolution(step,tau,alpha,penalty,mu,varargin)
    switch lower(penalty)
        case 'canonical'
            ...
            % variants
            subsolution = diploid_2p1c_Projection_fixindv(subsolution, 3);
          %  subsolution
