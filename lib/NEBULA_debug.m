...
if saveobjective
    ...
    objective(iter) = computeobjective(x,y,Ax,noisetype,subvectors,reg_params_all,logepsilon,penalty,WT);
end
if savereconerror
            ...
            if monotone 
                ...
                while (accept == 0)
                   ...
                   %fprintf('alpha %12.4f \n', alpha) 
                    ...
                    objective(iter + 1) = computeobjective(x,y,Ax,...
...
% ==========================
function objective = computeobjective(x,y,Ax,noisetype,subvectors,reg_params_all,logepsilon,...
    penalty,varargin)
% Perhaps change to varargin 
